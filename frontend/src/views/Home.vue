<template>
  <v-container class="fill-height home-container">
    <v-responsive class="align-center text-center fill-height">
      ...
      <div class="text-home">Templete Dratini - Jvaletim</div>
      <div class="button-container">
        <v-btn color="#C2997B" @click="$router.push('/eevee')">Eevee</v-btn>
        <v-btn color="#FFDE91" @click="$router.push('/psyduck')">Psyduck</v-btn>
      </div>
    </v-responsive>
  </v-container>
</template>
